...
Meu trabalho conecta **dados, automação e operações**, ajudando times a migrarem de processos manuais para fluxos escaláveis e orientados por dados.

Tenho sólida experiência apoiando áreas de **Compliance, Customer Experience, Risco, Produto e Operações** por meio de modelagem de dados, automação de processos e soluções analíticas. Gosto de transformar dados complexos em insights acionáveis e construir ferramentas que tornam a tomada de decisão mais rápida e eficiente.
